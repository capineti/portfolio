      ...
      <header className={`layout-header ${isScrolled ? 'scrolled' : ''}`}>
        <div className="header-container">
          ...
          <div className="header-controls">
            {import.meta.env.DEV && (
              <button className="playground-btn" onClick={() => onNavigate && onNavigate('playground')} title="Laboratorio de Componentes">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="playground-icon">
                  <path d="M20.71 5.63l-2.34-2.34c-0.39-0.39-1.02-0.39-1.41 0l-3.12 3.12-1.93-1.91-1.41 1.41 1.42 1.42L3 16.25V21h4.75l8.92-8.92 1.42 1.42 1.41-1.41-1.92-1.92 3.12-3.12c0.4-0.4 0.4-1.03 0.01-1.42zM6.92 19L5 17.08l8.06-8.06 1.92 1.92L6.92 19z" />
                </svg>
              </button>
            )}
